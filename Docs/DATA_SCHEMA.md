...
│   │   ├── footage/          ← scrapping-agent が確定DLした素材
...
├── styles/                    ← 台本スタイル（scripting-agent。掛け合い/ナレ等の雛形）
...
| scrapping-agent | `episodes/epNN/script.json` | `episodes/epNN/footage.json`, `episodes/epNN/footage/` |
